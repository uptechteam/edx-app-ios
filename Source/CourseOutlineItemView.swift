...
public class CourseOutlineItemView: UIView {
    static let detailFontStyle = OEXTextStyle(weight: .Normal, size: .Base, color : OEXStyles.sharedStyles().neutralBase())
    
    private let fontStyle = OEXTextStyle(weight: .Normal, size: .Large, color : OEXStyles.sharedStyles().neutralBlack())
